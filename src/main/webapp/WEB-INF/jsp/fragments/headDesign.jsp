...
<body>
	...
	<nav>
		<ul class="menu">
			...
			<li class="accueil"><a href="ServletEnchere">Acheter</a></li>
			<li class="accueil"><a href="ServletVenteArticle">Vendre</a></li>
			<li class="accueil"><a href="ServletModifArticle">Modifier</a></li>
			<li class="accueil"><a href="ServletAffichageUtilisateur">Mon Profil</a></li>
		</ul>
	</nav>
